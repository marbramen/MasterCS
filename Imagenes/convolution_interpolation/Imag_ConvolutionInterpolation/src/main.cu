...
int main(){
	string path = "/home/cesar/CesarBragagnini/MCS/others/Imag_Convolution/";
	string imagens[15] = {"wallPaper08.jpeg","wallPaper07.pgm","wallPaper01.jpg","wallPaper02.jpg",
			"wallPaper04.jpg","wallPaper09.jpg","wallPaper12.jpg","wallPaper05.jpg","wallPaper03.jpg","wallPaper06.jpg",
			"wallPaper11.jpg","wallPaper13.jpg","wallPaper14.jpg","wallPaper15.jpg","wallPaper10.jpg"};
	string dirOut[15] = {"wallPaper08","wallPaper07","wallPaper01","wallPaper02",
			"wallPaper04","wallPaper09","wallPaper12","wallPaper05","wallPaper03","wallPaper06",
			"wallPaper11","wallPaper13","wallPaper14","wallPaper15","wallPaper10"};
...
//	string dirOut[1] = {"wallPaper08"};
	...
	for(int i = 0; i < nImages; i++){
		...
		printf("%s,%dx%d,%ld,", imagens[i].c_str(),inMatGrayImage.rows, inMatGrayImage.cols, (long)inMatGrayImage.cols * (long)inMatGrayImage.rows);
		...
		for(int j = 0; j < nKernels; j++){
			...
			imwrite(path + dirOut[i] + "/grayCuda_" + intToString(arrayKernel[j]) + "_" + imagens[i], outMatImage);
		}
		printf("\n");
